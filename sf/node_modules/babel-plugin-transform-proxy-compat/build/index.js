...
var compatPlugin = function (_a) {
    ...
    function getMemberExpressionPropertyList(node) {
        ...
        return __spreadArray(__spreadArray([], objectPath), [
            {
                node: property,
                computed: computed,
            },
        ...
        CallExpression: function (path) {
            ...
            if (t.isMemberExpression(callee) && !callee[NO_TRANSFORM]) {
                ...
                if (t.isStringLiteral(normalizedPropertyName, { value: 'concat' })) {
                    ...
                    replacement = t.callExpression(id, __spreadArray([object], args));
                }
                    ...
                    replacement = t.callExpression(id, __spreadArray([object, normalizedPropertyName], args));
                }
            ...
            Program: {
                ...
                enter: function (path) {
                    for (var _i = 0, _a = path.node.body; _i < _a.length; _i++) {
                        ...
                        var comments = __spreadArray(__spreadArray([], leadingComments), trailingComments);
