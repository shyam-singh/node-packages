...
const output_configs_1 = require("./output-configs");
/**
...
function getResourceUrlPrefix(resource = { type: '', name: '' }, mode, uid) {
    ...
    const isComponent = type === exports.RESOURCE_TYPES.COMPONENT;
    assert(type, 'Type not specified');
    assert(mode, 'Mode not specified');
    assert(output_configs_1.isValidMode(mode), `Invalid mode: ${mode}`);
