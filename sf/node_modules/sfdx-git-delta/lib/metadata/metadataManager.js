...
const isPackable = type => !Array.from(inFileMetadata.values()).find(inFileDef => inFileDef.xmlName === type).excluded;
const getInFileAttributes = metadata => inFileMetadata.size
    ? inFileMetadata
...
const getSharedFolderMetadata = metadata => sharedFolderMetadata.size
