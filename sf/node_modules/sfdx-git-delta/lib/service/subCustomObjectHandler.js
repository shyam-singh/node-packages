...
const { MASTER_DETAIL_TAG, OBJECT_META_XML_SUFFIX, } = require('../utils/metadataConstants');
...
class SubCustomObjectHandler extends StandardHandler {
    async handleAddition() {
        ...
        const customObjectDirPath = this.splittedLine
            ...
            .join(sep);
        const customObjectName = this.splittedLine[this.splittedLine.indexOf(this.type) - 1];
        const customObjectPath = join(customObjectDirPath, `${customObjectName}.${OBJECT_META_XML_SUFFIX}`);
...
//# sourceMappingURL=subCustomObjectHandler.js.map