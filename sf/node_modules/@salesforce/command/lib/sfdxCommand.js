...
class SfdxCommand extends command_1.default {
    ...
    static getVarArgsConfig() {
        if (ts_types_1.isBoolean(this.varargs)) {
    ...
    parseVarargs(args = []) {
        ...
        if (!args.length && !ts_types_1.isBoolean(descriptor) && descriptor.required) {
        ...
        args.forEach((arg) => {
            ...
            if (!ts_types_1.isBoolean(descriptor) && descriptor.validator) {
    ...
    formatError(error) {
        ...
        // Format any actions.
        if (ts_types_1.get(error, 'actions.length')) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    static get flags() {
        return sfdxFlags_1.buildSfdxFlags(this.flagsConfig, {
