<template>
    <div class="slds-p-around_medium" ontouchmove={handleTouchMove}>
        <lightning-mobile-grouped-combobox
            aria-label={placeholder}
            filter-icon-name={filterIconName}
            items={state.data}
        ...
        <template if:true={emptyState.show}>
            <div class="slds-illustration slds-illustration_small">
                ...
                <div class="slds-text-longform">
                  <div class="slds-text-heading_medium">{emptyState.text}</div>
                  <div class="slds-text-heading_small">{emptyState.subText}</div>
                </div>
            </div>
        </template>
    </div>
