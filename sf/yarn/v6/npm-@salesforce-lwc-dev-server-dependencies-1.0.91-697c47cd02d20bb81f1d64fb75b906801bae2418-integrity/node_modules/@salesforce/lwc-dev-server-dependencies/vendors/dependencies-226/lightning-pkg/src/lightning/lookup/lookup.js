...
export default class LightningLookup extends LightningElement {
    ...
    get _constraint() {
        if (!this._constraintApi) {
            this._constraintApi = new FieldConstraintApi(() => this, {
                ...
                badInput: () => {
                    return this._lookupElement.inputText
    ...
    handleLookupRecordsRequest(event) {
        ...
        const queryString = LookupUtils.computeQueryString(
    ...
    isCreateNewEnabled() {
        return (
            this.showCreateNew &&
            this._apiNamesWithCreateNewEnabled.includes(
    ...
    updateMetadata() {
        ...
        this._requestParams[
            GET_LOOKUP_RECORDS_WIRE_CONSTANTS.QUERY_PARAMS_DEPENDENT_FIELD_BINDINGS
        ] = this._metadataManager.getBindingsString(this._record);
    ...
    _logItemSelected(recordId) {
        ...
        log(
            ...
            LOGGING_CONSTANTS.LOG_TARGET_LOOKUP_SUGGESTION_OPTION,
            {
                ...
                position,
                qType: this._isMRU
                    ? GET_LOOKUP_RECORDS_WIRE_CONSTANTS.LOG_CONTEXT_Q_TYPE_MRU
                    : GET_LOOKUP_RECORDS_WIRE_CONSTANTS.LOG_CONTEXT_Q_TYPE_TYPEAHEAD,
