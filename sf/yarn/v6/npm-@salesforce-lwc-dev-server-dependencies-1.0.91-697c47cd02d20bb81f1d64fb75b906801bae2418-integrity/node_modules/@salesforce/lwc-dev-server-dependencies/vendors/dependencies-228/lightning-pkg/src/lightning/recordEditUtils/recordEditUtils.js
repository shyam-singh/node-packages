...
export { deepCopy } from 'lightning/utilsPrivate';
...
/**
 * Get record type id from the recordUi object
 * @param {Object} recordUi The record ui object
 * @returns {String} the record type id
 */
