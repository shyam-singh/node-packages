...
export default class LightningInput extends LightningElement {
    ...
    @api
    get selectionEnd() {
        return this._inputElement ? this._inputElement.selectionEnd : undefined;
    }
    ...
    preserveSelection() {
        this._selectionStartCached = this._inputElement.selectionStart;
        this._selectionEndCached = this._inputElement.selectionEnd;
    }
    ...
    restoreSelection() {
        if (
            ...
            this._inputElement.selectionStart = this._selectionStartCached;
            this._inputElement.selectionEnd = this._selectionEndCached;
        }
    }
