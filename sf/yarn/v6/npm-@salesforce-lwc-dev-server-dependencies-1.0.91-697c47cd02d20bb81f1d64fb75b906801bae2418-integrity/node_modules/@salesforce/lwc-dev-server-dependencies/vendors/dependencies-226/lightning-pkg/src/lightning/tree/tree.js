...
export default class LightningTree extends LightningElement {
    ...
    handleTreeFocusIn(event) {
        ...
        if (
            this._currentFocusedItem &&
            (relatedTarget && relatedTarget.tagName !== 'LIGHTNING-TREE-ITEM')
        ) {
     ...
     * @param {boolean} shouldFocus - should focus or not when calling the callback, by default is true, false is passed
     *          when only visual focus is necessary
     */
