...
export class TreeData {
    ...
    /**
     * Updates the focused item index. Reset index to 0 when no valid item is
     * selected to start keyboard nav from the first node.
     * @param {Number} focused - index of focused item
     * @returns {Object} focused item at given index
     */
