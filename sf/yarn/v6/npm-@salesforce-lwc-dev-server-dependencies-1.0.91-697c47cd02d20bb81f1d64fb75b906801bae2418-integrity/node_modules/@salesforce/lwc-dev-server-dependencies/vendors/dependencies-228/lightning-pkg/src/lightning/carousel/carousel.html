                ...
                <span class="slds-carousel__autoplay">
                    <button class="slds-button slds-button_icon slds-button_icon-border-filled slds-button_icon-x-small"
                        ...
                        <lightning-primitive-icon
                            ...
                            size="x-small"
                        ></lightning-primitive-icon>
                        <span class="slds-assistive-text">{i18n.autoPlay}</span>
                    </button>
                </span>
            </template>
            <div class="slds-carousel__panels" style={carouselPanelsStyle} ontouchstart={handleTouchStart} ontouchend={handleTouchEnd}>
                <slot></slot>
            </div>
