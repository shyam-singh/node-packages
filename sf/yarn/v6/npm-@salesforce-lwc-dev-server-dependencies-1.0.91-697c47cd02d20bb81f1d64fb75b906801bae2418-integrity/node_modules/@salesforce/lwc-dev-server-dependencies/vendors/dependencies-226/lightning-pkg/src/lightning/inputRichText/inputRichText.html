<template>
    ...
    <template if:true={linkPanelOpen}>
        <div class="slds-popover slds-popover__body" onfocusout={handleLinkPanelFocusOut} onfocusin={handleLinkPanelFocusIn}>
