...
const messages = core_1.Messages.loadMessages('sfdx-git-delta', COMMAND_NAME);
class SourceDeltaGenerate extends command_1.SfdxCommand {
    async run() {
        const output = {
            error: null,
...
SourceDeltaGenerate.description = messages.getMessage('command', []);
SourceDeltaGenerate.flagsConfig = {
    ...
    'ignore-destructive': command_1.flags.filepath({
        char: 'D',
...
exports.default = SourceDeltaGenerate;
