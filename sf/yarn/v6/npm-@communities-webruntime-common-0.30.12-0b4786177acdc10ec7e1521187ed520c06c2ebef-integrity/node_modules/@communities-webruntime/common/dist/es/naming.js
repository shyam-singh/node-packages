 ...
 */
import { convertToKebabCase } from './strings';
const moduleSpecifierPattern = new RegExp(/^[a-z-A-Z_\d]+[/]{1}[a-zA-Z_\d]+$/);
const elementNamePattern = new RegExp(/^([a-z][a-z\d]*)(-[a-z\d]+)*$/);
...
/**
 * Converts an LWC module specifier (e.g. x/shopButton) to the
 * corresponding element name (e.g. x-shop-button)
 */
